      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground/60 mt-6 max-w-2xl mx-auto">
            I&apos;m always interested in hearing about new mobile development opportunities and exciting projects. 
          ...
          <div className="space-y-6">
            ...
            <div className="pt-6">
              ...
              <p className="text-foreground/70 leading-relaxed">
                I&apos;m currently available for freelance mobile development work and full-time opportunities. 
                Whether you have a mobile app idea or just want to say hi, I&apos;ll try my best to get back to you!
              </p>
            </div>
          </div>
        </div>
